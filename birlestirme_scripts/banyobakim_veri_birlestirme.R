...
ebebek <- dbReadTable(con, "ebebek_banyo")
tablo1 <- dbReadTable(con, "ebebek_civil_banyo")
tablo2 <- dbReadTable(con, "ebebek_babymall_banyo")
tablo3 <- dbReadTable(con, "ebebek_madrenino_banyo")
tablo4 <- dbReadTable(con, "ebebek_bebekhouse_banyo")
tablo5 <- dbReadTable(con, "ebebek_welcomebaby_banyo")
...
dbWriteTable(con, "banyobakim_verileri", merged_df, overwrite = TRUE)
