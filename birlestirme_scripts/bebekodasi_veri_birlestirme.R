...
ebebek <- dbReadTable(con, "ebebek_bebekodasi")
tablo1 <- dbReadTable(con, "ebebek_civil_bebekodasi")
tablo2 <- dbReadTable(con, "ebebek_babymall_bebekodasi")
tablo3 <- dbReadTable(con, "ebebek_madrenino_bebekodasi")
tablo4 <- dbReadTable(con, "ebebek_bebekhouse_bebekodasi")
tablo5 <- dbReadTable(con, "ebebek_welcomebaby_bebekodasi")
...
dbWriteTable(con, "bebekodasi_verileri", merged_df, overwrite = TRUE)
