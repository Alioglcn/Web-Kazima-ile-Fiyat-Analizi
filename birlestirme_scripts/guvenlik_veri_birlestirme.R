...
ebebek <- dbReadTable(con, "ebebek_guvenlik")
tablo1 <- dbReadTable(con, "ebebek_civil_guvenlik")
tablo2 <- dbReadTable(con, "ebebek_babymall_guvenlik")
tablo3 <- dbReadTable(con, "ebebek_madrenino_guvenlik")
tablo4 <- dbReadTable(con, "ebebek_bebekhouse_guvenlik")
tablo5 <- dbReadTable(con, "ebebek_welcomebaby_guvenlik")
...
dbWriteTable(con, "guvenlik_verileri", merged_df, overwrite = TRUE)
