...
ebebek <- dbReadTable(con, "ebebek_oyuncak")
tablo1 <- dbReadTable(con, "ebebek_civil_oyuncak")
tablo2 <- dbReadTable(con, "ebebek_babymall_oyuncak")
tablo3 <- dbReadTable(con, "ebebek_madrenino_oyuncak")
tablo4 <- dbReadTable(con, "ebebek_bebekhouse_oyuncak")
tablo5 <- dbReadTable(con, "ebebek_welcomebaby_oyuncak")
...
dbWriteTable(con, "oyuncak_verileri", merged_df, overwrite = TRUE)
